        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
              <input class="input" placeholder="Search name/email/make/model" v-model="q" @keyup.enter="applyFilters" />
            ...
            <div v-else>
              <div v-if="loans.data.length === 0" class="text-gray-500">No applications found.</div>
              <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                  ...
                  <tbody>
                    <tr v-for="row in loans.data" :key="row.id" class="border-t hover:bg-gray-50 cursor-pointer"
                      ...
                      <td class="py-2 pr-4">A${{ Number(row.purchase_price).toLocaleString() }}</td>
...
.btn-primary { @apply rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700; }
</style>
